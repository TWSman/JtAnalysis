...
def main(): 
  ...
  print "Input file: "
  print filename
  FullJets_R04 = dataset("Full jets R=0.4",NFIN=0,filename=filename,directory='data/BayesSubUnfolding',color=2,style=24,rebin=5)
  ...
  if(separate > 0):
    ...
    plt.savefig("PythonFigures/UnfoldedFullJetsR04JetConeJtFinal.pdf",format='pdf') #Save figure
    plt.show() #Draw figure on screen
